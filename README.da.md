...
brew install anomalyco/tap/nexusflow # macOS og Linux (anbefalet, altid up to date)
brew install nexusflow              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
NexusFlow findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/anomalyco/nexusflow/releases) eller [nexusflow.ai/download](https://nexusflow.ai/download).
...
1. `$NEXUSFLOW_INSTALL_DIR` - Tilpasset installationsmappe
...
NexusFlow har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://nexusflow.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af NexusFlow, [**se vores docs**](https://nexusflow.ai/docs).

### Bidrag

Hvis du vil bidrage til NexusFlow, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på NexusFlow

Hvis du arbejder på et projekt der er relateret til NexusFlow og bruger "nexusflow" som en del af navnet; f.eks. "nexusflow-dashboard" eller "nexusflow-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af NexusFlow-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/nexusflow) | [X.com](https://x.com/nexusflow)
