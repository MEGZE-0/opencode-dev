...
Generates UPCOMING_CHANGELOG.md by running the nexusflow changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for nexusflow run (default: low)
      --quiet            Suppress nexusflow command output unless it fails
