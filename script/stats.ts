...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/nexusflow/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/nexusflow...\n")
...
console.log("Fetching npm all-time downloads for nexusflow-ai...\n")
const npmDownloads = await fetchNpmDownloads("nexusflow-ai")
