...
npm i -g nexusflow-ai@latest        # o bun/pnpm/yarn
scoop install nexusflow             # Windows
choco install nexusflow             # Windows
brew install anomalyco/tap/nexusflow # macOS y Linux (recomendado, siempre al día)
brew install nexusflow              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S nexusflow            # Arch Linux (Stable)
paru -S nexusflow-bin               # Arch Linux (Latest from AUR)
mise use -g nexusflow               # cualquier sistema
nix run nixpkgs#nexusflow           # o github:anomalyco/nexusflow para la rama dev más reciente
```
...
NexusFlow también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/nexusflow/releases) o desde [nexusflow.ai/download](https://nexusflow.ai/download).
...
1. `$NEXUSFLOW_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.nexusflow/bin` - Alternativa por defecto
...
NexusFlow incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://nexusflow.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar NexusFlow, [**ve a nuestra documentación**](https://nexusflow.ai/docs).

### Contribuir

Si te interesa contribuir a NexusFlow, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en NexusFlow

Si estás trabajando en un proyecto basado en NexusFlow y usas "nexusflow" como parte del nombre, por ejemplo, "nexusflow-dashboard" u "nexusflow-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de NexusFlow y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/nexusflow) | [X.com](https://x.com/nexusflow)
