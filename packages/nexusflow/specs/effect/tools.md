...
Practical reference for the current tool-migration state in `packages/nexusflow`.
...
Tool tests should use the existing Effect helpers in `packages/nexusflow/test/lib/effect.ts`:
