...
>()("@nexusflow/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@nexusflow/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.NEXUSFLOW_WORKSPACE_ID ? WorkspaceID.make(Flag.NEXUSFLOW_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-nexusflow-directory"] || process.cwd()
}
