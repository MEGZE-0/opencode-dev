...
import { CreatorApi } from "./groups/creator"
...
export const RootHttpApi = HttpApi.make("nexusflow-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("nexusflow-instance")
  .addHttpApi(ConfigApi)
  .addHttpApi(CreatorApi)
...
export const NexusFlowHttpApi = HttpApi.make("nexusflow")
