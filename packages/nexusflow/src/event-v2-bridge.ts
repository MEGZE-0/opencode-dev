...
// nexusflow and the HTTP event stream still expect legacy bus/sync payloads.
...
import "@nexusflow/core/account"
import "@nexusflow/core/catalog"
import "@nexusflow/core/session-event"
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@nexusflow/EventV2Bridge") {}
