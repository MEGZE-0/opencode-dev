...
<html>
  <head>
    <title>NexusFlow - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>NexusFlow - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "nexusflow"
      output.headers["User-Agent"] = `nexusflow/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
