import type * as SDK from "@nexusflow/sdk/v2"
...
const disabled = process.env["NEXUSFLOW_DISABLE_SHARE"] === "true" || process.env["NEXUSFLOW_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@nexusflow/ShareNext") {}
