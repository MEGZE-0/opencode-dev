...
export class Service extends Context.Service<Service, Interface>()("@nexusflow/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __NEXUSFLOW_PHOTON_WASM_PATH?: string }).__NEXUSFLOW_PHOTON_WASM_PATH =
