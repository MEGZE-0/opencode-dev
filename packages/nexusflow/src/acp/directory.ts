...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@nexusflow/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@nexusflow/ACPDirectory") {}
