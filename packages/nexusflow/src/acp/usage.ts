...
import type { AssistantMessage as NexusFlowAssistantMessage, Message } from "@nexusflow/sdk/v2"
...
export type AssistantTokenCost = Pick<NexusFlowAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<NexusFlowAssistantMessage, "role"> &
  Partial<Pick<NexusFlowAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@nexusflow/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@nexusflow/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@nexusflow/ACPUsage") {}
