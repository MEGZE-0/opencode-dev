...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@nexusflow/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@nexusflow/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.NEXUSFLOW_FAKE_VCS)
