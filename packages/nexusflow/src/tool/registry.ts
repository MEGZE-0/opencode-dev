...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@nexusflow/plugin"
...
export function webSearchEnabled(providerID: ProviderID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderID.nexusflow || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@nexusflow/ToolRegistry") {}
