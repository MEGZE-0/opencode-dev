...
import { sanitizedProcessEnv } from "@nexusflow/core/util/nexusflow-process"
import { which } from "@/util/which"
import { NonNegativeInt } from "@nexusflow/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@nexusflow/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".nexusflow") || file.includes(".nexusflow")) continue
