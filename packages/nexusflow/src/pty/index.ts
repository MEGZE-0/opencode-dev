...
import { NonNegativeInt, PositiveInt } from "@nexusflow/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@nexusflow/Pty") {}
