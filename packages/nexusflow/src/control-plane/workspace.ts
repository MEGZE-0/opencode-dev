...
export class Service extends Context.Service<Service, Interface>()("@nexusflow/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        NEXUSFLOW_AUTH_CONTENT: authContent,
        NEXUSFLOW_WORKSPACE_ID: config.id,
        NEXUSFLOW_EXPERIMENTAL_WORKSPACES: "true",
