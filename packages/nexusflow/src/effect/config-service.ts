 ...
 *   "@nexusflow/ServerAuthConfig",
 *   {
 *     password: Config.string("NEXUSFLOW_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("NEXUSFLOW_SERVER_USERNAME").pipe(Config.withDefault("nexusflow")),
 *   },
 * ) {}
 *
