import type { JsonSchema, LLMRequest, ProviderMetadata } from "@nexusflow/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@nexusflow/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @nexusflow/llm request objects from nexusflow's session/AI SDK-shaped data.
  return LLM.request({
