import { Slug } from "@nexusflow/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@nexusflow/llm"
...
import { NonNegativeInt, optionalOmitUndefined } from "@nexusflow/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".nexusflow", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@nexusflow/Session") {}
