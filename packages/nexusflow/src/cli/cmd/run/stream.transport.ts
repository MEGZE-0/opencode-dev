...
import type { Event, GlobalEvent, OpencodeClient } from "@nexusflow/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@nexusflow/RunStreamTransport") {}
