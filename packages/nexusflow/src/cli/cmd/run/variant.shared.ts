...
//
// The saved variant persists across sessions in ~/.local/state/nexusflow/model.json
...
class Service extends Context.Service<Service, VariantService>()("@nexusflow/RunVariant") {}
