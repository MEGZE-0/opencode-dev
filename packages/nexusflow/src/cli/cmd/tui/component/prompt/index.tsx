...
import type { AssistantMessage, FilePart, UserMessage } from "@nexusflow/sdk/v2"
...
import { NEXUSFLOW_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOpencodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.NEXUSFLOW_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
