...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips nexusflow-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-nexusflow-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-nexusflow-directory")).toBeNull()
      expect(result.get("x-nexusflow-workspace")).toBeNull()
