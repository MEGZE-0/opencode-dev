...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      NEXUSFLOW_EXPERIMENTAL_WORKSPACES: Flag.NEXUSFLOW_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.NEXUSFLOW_EXPERIMENTAL_WORKSPACES = original.NEXUSFLOW_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
