...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips nexusflow-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-nexusflow-directory"]).toBeUndefined()
      expect(forwarded["x-nexusflow-workspace"]).toBeUndefined()
