...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/nexusflow.git")).toEqual({ owner: "sst", repo: "nexusflow" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/nexusflow")).toEqual({ owner: "sst", repo: "nexusflow" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/nexusflow.git")).toEqual({ owner: "sst", repo: "nexusflow" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/nexusflow")).toEqual({ owner: "sst", repo: "nexusflow" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/nexusflow.git")).toEqual({ owner: "sst", repo: "nexusflow" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/nexusflow")).toEqual({ owner: "sst", repo: "nexusflow" })
})
