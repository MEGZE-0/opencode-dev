...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/nexusflow/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/nexusflow (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/nexusflow/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/nexusflow/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const NEXUSFLOW_DB|NEXUSFLOW_DB|NEXUSFLOW_DEV|Global\\.Path\\.data|data =" in packages/nexusflow/src (115 matches)',
  },
] as const
