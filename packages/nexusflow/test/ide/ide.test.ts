...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NEXUSFLOW_CALLER", () => {
    process.env["NEXUSFLOW_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NEXUSFLOW_CALLER", () => {
    process.env["NEXUSFLOW_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NEXUSFLOW_CALLER", () => {
    process.env["NEXUSFLOW_CALLER"] = "unknown"
