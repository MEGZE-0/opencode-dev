  ...
  scout.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "nexusflow-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "nexusflow-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "nexusflow-glob-reference/repo",
        },
      },
    },
  )
