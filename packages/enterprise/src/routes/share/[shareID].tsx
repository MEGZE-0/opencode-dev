import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@nexusflow/sdk/v2"
import { SessionTurn } from "@nexusflow/ui/session-turn"
import { SessionReview } from "@nexusflow/ui/session-review"
import { DataProvider } from "@nexusflow/ui/context"
import { FileComponentProvider } from "@nexusflow/ui/context/file"
import { WorkerPoolProvider } from "@nexusflow/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@nexusflow/ui/logo"
import { IconButton } from "@nexusflow/ui/icon-button"
import { ProviderIcon } from "@nexusflow/ui/provider-icon"
import { iife } from "@nexusflow/core/util/iife"
...
import { MessageNav } from "@nexusflow/ui/message-nav"
import { FileSSR } from "@nexusflow/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@nexusflow/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/nexusflow-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | NexusFlow</Title>
              </Show>
              <Meta name="description" content="nexusflow - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://nexusflow.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
