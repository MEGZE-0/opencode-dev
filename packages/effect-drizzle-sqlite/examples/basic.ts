...
class Database extends Context.Service<Database, DatabaseShape>()("@nexusflow/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@nexusflow/example/UserStore") {
