...
import desktopAppIcon from "../../asset/lander/nexusflow-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://nexusflow.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>nexusflow.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g nexusflow-ai")}>
                <code>
                  npm i -g <strong>nexusflow-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g nexusflow-ai")}>
                <code>
                  bun add -g <strong>nexusflow-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/nexusflow")}>
                <code>
                  brew install <strong>anomalyco/tap/nexusflow</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S nexusflow")}>
                <code>
                  paru -S <strong>nexusflow</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask nexusflow-desktop")}>
                <code>
                  brew install --cask <strong>nexusflow-desktop</strong>
                </code>
                <CopyStatus />
              </button>
