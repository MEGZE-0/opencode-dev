...
import { and, Database, eq, isNull, lt, or, sql } from "@nexusflow/console-core/drizzle/index.js"
import { KeyTable } from "@nexusflow/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@nexusflow/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@nexusflow/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@nexusflow/console-core/util/date.js"
import { Identifier } from "@nexusflow/console-core/identifier.js"
import { Billing } from "@nexusflow/console-core/billing.js"
import { Actor } from "@nexusflow/console-core/actor.js"
import { WorkspaceTable } from "@nexusflow/console-core/schema/workspace.sql.js"
import { ZenData } from "@nexusflow/console-core/model.js"
import { Subscription } from "@nexusflow/console-core/subscription.js"
import { BlackData } from "@nexusflow/console-core/black.js"
import { UserTable } from "@nexusflow/console-core/schema/user.sql.js"
import { ModelTable } from "@nexusflow/console-core/schema/model.sql.js"
import { ProviderTable } from "@nexusflow/console-core/schema/provider.sql.js"
...
import { LiteData } from "@nexusflow/console-core/lite.js"
import { Resource } from "@nexusflow/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-nexusflow-session") ?? ""
    const requestId = input.request.headers.get("x-nexusflow-request") ?? ""
    const ocClient = input.request.headers.get("x-nexusflow-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-nexusflow-request")
          headers.delete("x-nexusflow-session")
          headers.delete("x-nexusflow-project")
          headers.delete("x-nexusflow-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://nexusflow.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://nexusflow.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://nexusflow.ai/workspace/${authInfo.workspaceID}/members`
