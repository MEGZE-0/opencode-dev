...
import compareVideo from "../../asset/lander/nexusflow-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/nexusflow-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="nexusflow:auth" content={loggedin() ? "true" : "false"} />
