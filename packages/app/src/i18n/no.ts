...
export const dict = {
  ...
  "dialog.provider.nexusflow.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.nexusflow.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.nexusflowGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av NexusFlow",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i NexusFlow.",
  ...
  "provider.connect.nexusflowZen.line1":
    "NexusFlow Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.nexusflowZen.visit.prefix": "Besøk ",
  "provider.connect.nexusflowZen.visit.link": "nexusflow.ai/zen",
  "provider.connect.nexusflowZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i NexusFlow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i NexusFlow.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i nexusflow.json",
  ...
  "dialog.server.description": "Bytt hvilken NexusFlow-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av NexusFlow ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til NexusFlow-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (nexusflow.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at NexusFlow ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "NexusFlow inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør NexusFlow-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for NexusFlow",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan NexusFlow ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om NexusFlow skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan NexusFlow er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når NexusFlow starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av NexusFlow.",
