...
export const dict = {
  ...
  "dialog.provider.nexusflow.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.nexusflow.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.nexusflowGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "NexusFlow tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve NexusFlow'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.nexusflowZen.line1":
    "NexusFlow Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.nexusflowZen.visit.prefix": "",
  "provider.connect.nexusflowZen.visit.link": "nexusflow.ai/zen",
  "provider.connect.nexusflowZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve NexusFlow'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak NexusFlow'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler nexusflow.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi NexusFlow sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "NexusFlow'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı NexusFlow ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (nexusflow.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: NexusFlow henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "NexusFlow ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "NexusFlow Masaüstü",
  ...
  "settings.desktop.wsl.description": "NexusFlow sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "NexusFlow'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "NexusFlow'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "NexusFlow'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "NexusFlow'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "NexusFlow başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "NexusFlow'un en son sürümünü kullanıyorsunuz.",
