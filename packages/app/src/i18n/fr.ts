export const dict = {
  ...
  "dialog.provider.nexusflow.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.nexusflow.tagline": "Modèles optimisés et fiables",
  "dialog.provider.nexusflowGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par NexusFlow",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans NexusFlow.",
  ...
  "provider.connect.nexusflowZen.line1":
    "NexusFlow Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.nexusflowZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.nexusflowZen.visit.prefix": "Visitez ",
  "provider.connect.nexusflowZen.visit.link": "nexusflow.ai/zen",
  "provider.connect.nexusflowZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans NexusFlow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans NexusFlow.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans nexusflow.json",
  ...
  "dialog.server.description": "Changez le serveur NexusFlow auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'NexusFlow ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe NexusFlow",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (nexusflow.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'NexusFlow ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "NexusFlow inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "NexusFlow Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur NexusFlow dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour NexusFlow",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'NexusFlow sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si NexusFlow suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'NexusFlow.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'NexusFlow",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'NexusFlow.",
