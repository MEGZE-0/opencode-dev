export const dict = {
  ...
  "dialog.provider.nexusflow.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.nexusflow.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.nexusflowGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo NexusFlow",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no NexusFlow.",
  ...
  "provider.connect.nexusflowZen.line1":
    "NexusFlow Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.nexusflowZen.visit.prefix": "Visite ",
  "provider.connect.nexusflowZen.visit.link": "nexusflow.ai/zen",
  "provider.connect.nexusflowZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no NexusFlow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no NexusFlow.",
  ...
  "dialog.plugins.empty": "Plugins configurados em nexusflow.json",
  ...
  "dialog.server.description": "Trocar para qual servidor NexusFlow este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do NexusFlow ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do NexusFlow",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (nexusflow.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: NexusFlow ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexusFlow inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor NexusFlow dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do NexusFlow",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o NexusFlow aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o NexusFlow segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o NexusFlow é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o NexusFlow iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do NexusFlow.",
