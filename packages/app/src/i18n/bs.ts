export const dict = {
  ...
  "dialog.provider.nexusflow.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.nexusflow.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.nexusflowGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje NexusFlow",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u NexusFlow-u.",
  ...
  "provider.connect.nexusflowZen.line1":
    "NexusFlow Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.nexusflowZen.visit.prefix": "Posjeti ",
  "provider.connect.nexusflowZen.visit.link": "nexusflow.ai/zen",
  "provider.connect.nexusflowZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u NexusFlow-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u NexusFlow-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u nexusflow.json",
  ...
  "dialog.server.description": "Promijeni na koji se NexusFlow server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija NexusFlow-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku NexusFlow timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (nexusflow.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: NexusFlow još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NexusFlow uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni NexusFlow server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u NexusFlow-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako NexusFlow izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li NexusFlow prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu NexusFlow-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se NexusFlow pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju NexusFlow-a.",
