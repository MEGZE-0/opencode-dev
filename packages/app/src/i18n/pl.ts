export const dict = {
  ...
  "dialog.provider.nexusflow.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.nexusflow.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.nexusflowGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NexusFlow",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NexusFlow.",
  ...
  "provider.connect.nexusflowZen.line1":
    "NexusFlow Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.nexusflowZen.visit.prefix": "Odwiedź ",
  "provider.connect.nexusflowZen.visit.link": "nexusflow.ai/zen",
  "provider.connect.nexusflowZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NexusFlow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NexusFlow.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w nexusflow.json",
  ...
  "dialog.server.description": "Przełącz serwer NexusFlow, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja NexusFlow ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu NexusFlow",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (nexusflow.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "NexusFlow zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla NexusFlow",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd NexusFlow na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy NexusFlow ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw NexusFlow.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NexusFlow",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NexusFlow.",
