export const dict = {
  ...
  "dialog.provider.nexusflow.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.nexusflow.tagline": "Modelos optimizados y fiables",
  "dialog.provider.nexusflowGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por NexusFlow",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en NexusFlow.",
  ...
  "provider.connect.nexusflowZen.line1":
    "NexusFlow Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.nexusflowZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.nexusflowZen.visit.prefix": "Visita ",
  "provider.connect.nexusflowZen.visit.link": "nexusflow.ai/zen",
  "provider.connect.nexusflowZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en NexusFlow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en NexusFlow.",
  ...
  "dialog.plugins.empty": "Plugins configurados en nexusflow.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de NexusFlow se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de NexusFlow ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de NexusFlow",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (nexusflow.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, NexusFlow no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "NexusFlow incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor NexusFlow dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para NexusFlow",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve NexusFlow en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si NexusFlow sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de NexusFlow.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia NexusFlow",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de NexusFlow.",
