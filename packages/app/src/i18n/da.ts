export const dict = {
  ...
  "dialog.provider.nexusflow.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.nexusflow.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.nexusflowGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NexusFlow",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i NexusFlow.",
  ...
  "provider.connect.nexusflowZen.line1":
    "NexusFlow Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.nexusflowZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.nexusflowZen.visit.prefix": "Besøg ",
  "provider.connect.nexusflowZen.visit.link": "nexusflow.ai/zen",
  "provider.connect.nexusflowZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i NexusFlow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i NexusFlow.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i nexusflow.json",
  ...
  "dialog.server.description": "Skift hvilken NexusFlow-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af NexusFlow ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NexusFlow-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (nexusflow.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NexusFlow understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NexusFlow inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør NexusFlow-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NexusFlow",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan NexusFlow ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om NexusFlow følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan NexusFlow er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NexusFlow starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NexusFlow.",
