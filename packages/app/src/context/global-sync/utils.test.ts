...
import type { Agent } from "@nexusflow/sdk/v2/client"
...
describe("directoryKey", () => {
  test("normalizes slashes", () => {
    expect(String(directoryKey("C:\\Repos\\sst\\nexusflow"))).toBe("C:/Repos/sst/nexusflow")
    expect(String(directoryKey("C:/Repos/sst/nexusflow"))).toBe("C:/Repos/sst/nexusflow")
  })
