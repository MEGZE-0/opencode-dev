...
beforeAll(async () => {
  ...
  mock.module("@nexusflow/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@nexusflow/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@nexusflow/ui/icon", () => ({ Icon: () => null }))
  mock.module("@nexusflow/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
