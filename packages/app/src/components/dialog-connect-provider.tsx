import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@nexusflow/sdk/v2/client"
...
import { List, type ListRef } from "@nexusflow/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "nexusflow"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.nexusflowZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.nexusflowZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.nexusflowZen.visit.prefix")}
                <Link href="https://nexusflow.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.nexusflowZen.visit.link")}
                </Link>
                {language.t("provider.connect.nexusflowZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
