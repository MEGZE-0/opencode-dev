...
const releaseId = process.env.NEXUSFLOW_RELEASE
if (!releaseId) throw new Error("NEXUSFLOW_RELEASE is required")

const version = process.env.NEXUSFLOW_VERSION
if (!version) throw new Error("NEXUSFLOW_VERSION is required")
...
const macxTarGz = "nexusflow-desktop-mac-x64.app.tar.gz"
const macaTarGz = "nexusflow-desktop-mac-arm64.app.tar.gz"
