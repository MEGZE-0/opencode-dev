export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de NexusFlow",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de NexusFlow. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'nexusflow'.",
