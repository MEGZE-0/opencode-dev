export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من NexusFlow",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من NexusFlow، هل ترغب في تثبيته وإعادة تشغيله؟",
