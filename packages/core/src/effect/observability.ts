...
import { ensureProcessMetadata } from "../util/nexusflow-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    serviceName: "nexusflow",
    serviceVersion: InstallationVersion,
    attributes: {
      ...attributes,
      "deployment.environment.name": InstallationChannel,
      "nexusflow.client": Flag.NEXUSFLOW_CLIENT,
      "nexusflow.process_role": processMetadata.processRole,
      "nexusflow.run_id": processMetadata.runID,
