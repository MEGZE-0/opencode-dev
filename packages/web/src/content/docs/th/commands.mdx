...
สร้าง `.nexusflow/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ NexusFlow:
...
- ระดับผู้ใช้ (Global): `~/.config/nexusflow/commands/`
- ระดับโปรเจ็กต์: `.nexusflow/commands/`
...
NexusFlow มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
