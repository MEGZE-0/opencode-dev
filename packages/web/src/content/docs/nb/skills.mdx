...
Agentferdigheter lar NexusFlow oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går nexusflow opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
nexusflow viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `nexusflow.json`:
