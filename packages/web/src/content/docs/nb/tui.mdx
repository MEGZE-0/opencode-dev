---
title: TUI
description: Bruke nexusflow-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NexusFlow gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre NexusFlow starter TUI for gjeldende katalog.
...
Når du bruker NexusFlow TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til NexusFlow. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt NexusFlow. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `nexusflow.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge NexusFlow venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `nexusflow.default`.
