...
Opprett `.nexusflow/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom NexusFlow-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i NexusFlow [config](/docs/config):
...
- Per prosjekt: `.nexusflow/commands/`
...
NexusFlow inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
