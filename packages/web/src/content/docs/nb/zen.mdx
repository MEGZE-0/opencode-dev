---
title: Zen
description: Utvalgt liste over modeller levert av NexusFlow.
---
...
NexusFlow Zen er en liste over testede og verifiserte modeller levert av NexusFlow-teamet.

Zen fungerer som enhver annen leverandør i NexusFlow. Du logger inn på NexusFlow Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med NexusFlow.
:::
...
NexusFlow Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

NexusFlow Zen fungerer som enhver annen leverandør i NexusFlow.

1. Du logger inn på **<a href={console}>NexusFlow Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger NexusFlow Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i NexusFlow-konfigurasjonen din
bruker formatet `nexusflow/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `nexusflow/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på NexusFlow i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på NexusFlow i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på NexusFlow i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på NexusFlow i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet NexusFlow Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med NexusFlow også.
