---
title: Zen
description: Kuratierte Modellliste direkt von NexusFlow.
---
...
NexusFlow Zen ist eine Liste von getesteten und verifizierten Modellen, die vom NexusFlow-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in NexusFlow. Du meldest dich bei NexusFlow Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um NexusFlow zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit NexusFlow funktionieren.
:::
...
NexusFlow Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

NexusFlow Zen funktioniert wie jeder andere Provider in NexusFlow.

1. Du meldest dich bei **<a href={console}>NexusFlow Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst NexusFlow Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner NexusFlow-Konfiguration verwendet das Format `nexusflow/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `nexusflow/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf NexusFlow verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf NexusFlow verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf NexusFlow verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf NexusFlow verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben NexusFlow Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit NexusFlow auch jeden anderen Provider zu verwenden.
