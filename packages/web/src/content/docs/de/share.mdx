---
title: Teilen
description: Teile NexusFlow-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu NexusFlow-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht NexusFlow Folgendes:
...
NexusFlow hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt NexusFlow den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`nexusflow.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du nexusflow in deiner Organisation einsetzt.
