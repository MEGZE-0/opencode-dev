---
title: Zen
description: Lista selecionada de modelos fornecidos pelo NexusFlow.
---
...
O NexusFlow Zen é uma lista de modelos testados e verificados fornecidos pela equipe do NexusFlow.

O Zen funciona como qualquer outro provedor no NexusFlow. Você faz login no NexusFlow Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o NexusFlow.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o NexusFlow.
:::
...
O NexusFlow Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O NexusFlow Zen funciona como qualquer outro provedor no NexusFlow.

1. Você faz login no **<a href={console}>NexusFlow Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona NexusFlow Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do NexusFlow usa o formato `nexusflow/<model-id>`. Por exemplo, para GPT 5.5, você usaria `nexusflow/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no NexusFlow por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no NexusFlow por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no NexusFlow por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no NexusFlow por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o NexusFlow também.
