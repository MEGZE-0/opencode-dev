...
Crear `.nexusflow/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración NexusFlow o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su NexusFlow [config](/docs/config):
...
- Por proyecto: `.nexusflow/commands/`
...
nexusflow incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
