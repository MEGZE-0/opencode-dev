---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące nexusflow.
---

Funkcja udostępniania nexusflow umożliwia tworzenie publicznych linków do konwersacji nexusflow, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, nexusflow:
...
nexusflow obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie nexusflow korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `nexusflow.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu nexusflow w Twojej organizacji.
