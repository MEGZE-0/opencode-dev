---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala nexusflow.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

nexusflow zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie nexusflow uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI nexusflow, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do nexusflow. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij nexusflow. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `nexusflow.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo NexusFlow czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `nexusflow.default`.
