---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez NexusFlow.
---
...
NexusFlow Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół NexusFlow.

Zen działa jak każdy inny dostawca w NexusFlow. Logujesz się do NexusFlow Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z NexusFlow.
:::
...
NexusFlow Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

NexusFlow Zen działa jak każdy inny dostawca w NexusFlow.

1. Logujesz się do **<a href={console}>NexusFlow Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz NexusFlow Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji NexusFlow używa formatu
`nexusflow/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`nexusflow/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w NexusFlow przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w NexusFlow przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w NexusFlow przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w NexusFlow przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy NexusFlow Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w NexusFlow także dowolnego innego dostawcy.
