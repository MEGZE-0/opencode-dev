---
title: Zen
description: nexusflow tarafından sağlanan seçilmiş modeller listesi.
---
...
NexusFlow Zen, NexusFlow ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, NexusFlow'daki diğer sağlayıcılar gibi çalışır. NexusFlow Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve NexusFlow kullanmak için buna ihtiyacınız yoktur.
...
:::tip
NexusFlow ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
NexusFlow Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

NexusFlow Zen, NexusFlow'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>NexusFlow Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, NexusFlow Zen'i seçin ve API anahtarınızı yapıştırın.
...
NexusFlow yapılandırmanızdaki [model id](/docs/config/#models) `nexusflow/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `nexusflow/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için NexusFlow'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için NexusFlow'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Super Free, sınırlı bir süre için NexusFlow'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için NexusFlow'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
NexusFlow Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca NexusFlow ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
