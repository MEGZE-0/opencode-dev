---
title: Paylasim
description: nexusflow konusmalarini genel baglantilarla paylasin.
---

nexusflow'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda nexusflow:
...
nexusflow, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak nexusflow manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `nexusflow.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda nexusflow kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
