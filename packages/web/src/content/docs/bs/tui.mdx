---
title: TUI
description: Korištenje korisničkog interfejsa NexusFlow terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NexusFlow pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje NexusFlow pokreće TUI za trenutni direktorij.
...
Kada koristite NexusFlow TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u NexusFlow. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz NexusFlow. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `nexusflow.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo NexusFlow čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `nexusflow.default`.
