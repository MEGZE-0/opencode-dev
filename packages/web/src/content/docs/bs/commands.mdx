...
Kreiraj `.nexusflow/commands/test.md`:
...
Možete dodati prilagođene komande kroz NexusFlow konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom NexusFlow [config](/docs/config):
...
- Globalno: `~/.config/nexusflow/commands/`
- Po projektu: `.nexusflow/commands/`
...
NexusFlow uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
