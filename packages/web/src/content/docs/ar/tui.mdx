---
title: TUI
description: استخدام واجهة المستخدم TUI في NexusFlow.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر NexusFlow واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل NexusFlow إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة NexusFlow في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى NexusFlow. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من NexusFlow. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `nexusflow.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار NexusFlow بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `nexusflow.default`.
