...
Brug den til at bygge integrasjoner og kontrollere nexusflow programmatisk.
...
Opret en forekomst av nexusflow:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `nexusflow.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av nexusflow, kan du oprete en klientforekomst for at koble til den:
