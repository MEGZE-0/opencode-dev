---
title: Zen
description: Udvalgt liste over modeller leveret af NexusFlow.
---
...
NexusFlow Zen er en liste over testede og verificerede modeller leveret af NexusFlow-teamet.

Zen fungerer som enhver anden udbyder i NexusFlow. Du logger ind på NexusFlow Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med NexusFlow.
:::
...
NexusFlow Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

NexusFlow Zen fungerer som enhver anden udbyder i NexusFlow.

1. Du logger ind på **<a href={console}>NexusFlow Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger NexusFlow Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din NexusFlow-konfiguration
bruger formatet `nexusflow/<model-id>`. For eksempel ville du for GPT 5.5
bruge `nexusflow/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på NexusFlow i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på NexusFlow i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på NexusFlow i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på NexusFlow i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
Vi skabte NexusFlow Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med NexusFlow også.
