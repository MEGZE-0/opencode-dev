---
title: TUI
description: Brug af NexusFlow-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NexusFlow giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre NexusFlow starter TUI for den nuværende mappe.
...
Når du bruger NexusFlow TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til NexusFlow. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut NexusFlow. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `nexusflow.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe NexusFlow venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `nexusflow.default`.
