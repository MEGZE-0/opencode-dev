...
Opret `.nexusflow/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem NexusFlow-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din NexusFlow [config](/docs/config):
...
- Globalt: `~/.config/nexusflow/commands/`
- Pr. projekt: `.nexusflow/commands/`
...
nexusflow indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
