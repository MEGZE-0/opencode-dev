...
Schema-first LLM core for nexusflow. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@nexusflow/llm"
import { OpenAI } from "@nexusflow/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@nexusflow/llm/providers"
