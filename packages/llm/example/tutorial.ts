...
import { LLM, LLMClient, ProviderID, Tool } from "@nexusflow/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@nexusflow/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-nexusflow-tutorial": "1" },
    query: { debug: "1" },
  },
})
