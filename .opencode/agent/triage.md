...
Desktop application and browser-based app issues, including `nexusflow web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core nexusflow server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

NexusFlow Zen, NexusFlow Go, and billing issues.
