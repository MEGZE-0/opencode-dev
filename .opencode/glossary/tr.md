...
- PR #15835: https://github.com/anomalyco/nexusflow/pull/15835

## Do Not Translate (Locale Additions)

- `NexusFlow` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `nexusflow` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `NexusFlow` in prose, `nexusflow` only for exact technical identifiers
...
- Avoid changing `nexusflow` to `NexusFlow` inside commands, URLs, package names, or code literals
