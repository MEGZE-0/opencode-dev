...
Use this folder for locale-specific translation guidance that supplements `.nexusflow/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/nexusflow/pull/12345

## Do Not Translate (Locale Additions)

- `NexusFlow` (preserve casing)
