...
- PR #13942: https://github.com/anomalyco/nexusflow/pull/13942

## Do Not Translate (Locale Additions)

- `NexusFlow` (preserve casing in prose; keep `nexusflow` only when it is part of commands, package names, paths, or code)
- `NexusFlow Zen`
- `NexusFlow CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `nexusflow` in prose when referring to the product name; use `NexusFlow`
