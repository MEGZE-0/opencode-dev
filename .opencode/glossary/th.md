...
- PR #10809: https://github.com/anomalyco/nexusflow/pull/10809
- PR #11496: https://github.com/anomalyco/nexusflow/pull/11496

## Do Not Translate (Locale Additions)

- `NexusFlow` (preserve casing in prose; keep `nexusflow` only in commands, package names, paths, or code)
- `NexusFlow CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
