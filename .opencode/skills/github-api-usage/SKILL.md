...
title: GitHub API tactical patterns
version: 1.0.0
last-updated: 2026-06-12
description: GitHub API tactical patterns for NexusFlow specialist agents.
tags: [nexusflow, tactical, specialist]
applies-to: ["github-specialist"]
---

# GitHub API tactical patterns
...
1. Use REST for simple resources and GraphQL for graph-shaped data.
2. Handle pagination cursors explicitly.
3. Validate webhook event payload shape before acting.
